...
# Como executar
  No seu terminal Unix, apenas utilize o comando "make". Esse comando (caso eu não tenha errado em nada) serve para automatizar a compilação; caso você queira alterar as configurações dele, altere o arquivo "Makefile".
